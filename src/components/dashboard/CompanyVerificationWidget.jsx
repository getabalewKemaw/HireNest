...
const CompanyVerificationWidget = () => {
    ...
    const fetchStatus = async () => {
        try {
            ...
            if (response.data) {
                ...
                // If status is APPROVED but code not used, we stay in APPROVED state to enter code
                // In backend, APPROVED means admin approved, but code verification is still needed
    ...
    return (
        <div className="bg-white dark:bg-[#151C26] rounded-[2.5rem] border border-gray-100 dark:border-white/5 p-8 shadow-sm relative overflow-hidden group">
            ...
            <div className="relative z-10">
                ...
                {(status === 'PENDING' || (status === 'APPROVED' && verificationData?.codeUsed)) && (
                    <button
                    ...
                    >
                        {status === 'PENDING' ? 'Audit in Progress' : 'Profile Fully Unlocked'}
                    </button>
                )}
            </div>
                        ...
                        <div className="p-8 sm:p-10">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <button
                                    disabled={isLoading}
                                    type="submit"
                                    className="w-full py-5 bg-secondary text-white font-black rounded-3xl hover:bg-secondary-dark transition-all shadow-2xl shadow-secondary/20 flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed group"
                                >
