                ...
                <div className="flex-1">
                    ...
                    <div className="flex items-center gap-3 text-xs text-gray-500 dark:text-gray-400 mb-3 font-medium">
                        <span className="flex items-center gap-1 font-bold text-gray-700 dark:text-gray-300">
                            {companyName}
                            {job.companyVerified && <CheckCircle2 size={12} className="text-secondary" />}
                        </span>
                        <span>•</span>
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                        {workplaceType && (
                            <span className="px-3 py-1 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 text-[10px] font-black uppercase tracking-widest rounded-full border border-gray-200 dark:border-gray-600 transition-colors cursor-default">
                    ...
                    <div className="flex items-center gap-1 text-xs font-medium text-gray-500 dark:text-gray-400">
                        ...
                        <span className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-gray-50 dark:bg-gray-700/50 border border-gray-100 dark:border-gray-700 transition-colors">
                            <span className="text-[10px] font-black text-secondary uppercase tracking-widest">{currency || 'USD'}</span>
                            <span className="text-sm font-bold text-primary dark:text-white">
                                {salaryMin ? `${salaryMin.toLocaleString()} - ${salaryMax?.toLocaleString()}` : 'Negotiable'}
                            </span>
                        </span>
                    </div>
                </div>
